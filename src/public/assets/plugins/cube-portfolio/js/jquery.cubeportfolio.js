...
(function($, window, document, undefined) {
    ...
    var popup = {
        ...
        openLightbox: function(blocks, currentBlock) {
            ...
            $.each(blocks, function(index, item) {
                ...
                if ($.inArray(href, tempHref) === -1) {
                    ...
                    if (/youtube/i.test(href)) {
                        ...
                        // create new href
                        src = 'http://embed.ted.com/talks/' + href.substring(href.lastIndexOf('/') + 1) + '.ejs';
            ...
            t.originalStyle = $('ejs').attr('style');
        ...
        updateSinglePage: function(ejs, scripts, isWrap) {
            var t = this,
                counterMarkup,
                animationFinish;
        ...
        updateSinglePageInline: function(ejs, scripts) {
            var t = this;
        ...
        close: function(method, data) {
            ...
            if (t.type === 'singlePageInline') {
                ...
                if (t.originalStyle) {
                    $('ejs').attr('style', t.originalStyle);
                } else {
                    $('ejs').css({
                        overflow: '',
                        marginRight: ''
...
(function($, window, document, undefined) {
    ...
    function Plugin(parent) {
        ...
        t.searchNothingEJS = t.searchNothing.ejs();
    ...
    Plugin.prototype.runEvent = function(el) {
        ...
        t.parent.$obj.cubeportfolio('filter', function(blocks) {
            ...
            if (blocksNew.length === 0 && t.searchNothing.length) {
                var innerText = t.searchNothingEJS.replace('{{query}}', value);
                t.searchNothing.ejs(innerText);
